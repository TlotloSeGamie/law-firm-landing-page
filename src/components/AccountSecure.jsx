...
const AccountSecure = () => {
  ...
  const handleIdentityVerificationRoute = () => {
        ...
        <div className="secure-container">
          ...
          <div className="secure-texts">
            ...
            <p className="info-text">
              Create a strong password to keep your business data safe and
              secure.
            </p>
          </div>
          <form className="passwords">
            ...
            <button className="sign-up" onClick={handleIdentityVerificationRoute}>Sign Up</button>
          </form>
        </div>
      </div>
