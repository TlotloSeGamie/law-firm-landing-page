...
const SubscriptionPlan = () => {
  ...
  const handleSubscriptionPlanRoute = () => {
    navigate("/account-secure");
  };
  return (
      ...
      <div className="subscription-main-container">
        <div className="subscription-container">
          <div className="logoipsum">
            ...
            <p>
              Select a plan that fits your business needs, whether your're just
              getting started or ready to scale
            </p>
          </div>
          <div className="bill">
          ...
          <div className="subscription-btn">
            <button className="subscribe-btn" onClick={handleSubscriptionPlanRoute}>Subscribe</button>
            <p>
              By providing your card information,you allow us to charg your card
